                                    ...
                                    <div class="card-block">
                                        <h4 class="sub-title">Basic Inputs</h4>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control required" id="name"  name="name" maxlength="255" placeholder="Menu Name" required="reuired">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Menu Key</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control required" id="key"  name="key" maxlength="55" placeholder="Menu Key" required="reuired">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Menu Description</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control required" id="description"  name="description" placeholder="Menu Description" maxlength="255">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control required" id="url"  name="url" maxlength="255" placeholder="Menu URL" required="reuired">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Menu Icon</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control required" id="icon"  name="icon" placeholder="Menu Icon" maxlength="255">
                                                </div>
                                            </div>
                                            <div class="form-group row">
...
(function($){
    @if(!empty($menuInfo))
        $("#name").val("{{ old('name', $menuInfo->name) }}");
        $("#key").val("{{ old('key', $menuInfo->key) }}");
        $("#description").val("{{ old('description', $menuInfo->description) }}");
        $("#parent_id").val("{{ old('parent_id', $menuInfo->parent_id) }}");
        $("#url").val("{{ old('url', $menuInfo->url) }}");
        $("#icon").val("{{ old('icon', $menuInfo->icon) }}");
        $("#active").val("{{ old('active', $menuInfo->active) }}");
        $("#link_rights").val("{{ old('link_rights', $menuInfo->link_rights) }}");
    @endif
})(jQuery);
</script>
